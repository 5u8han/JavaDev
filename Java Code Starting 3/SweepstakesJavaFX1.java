...
public class SweepstakesJavaFX1 extends Application 
{
	...
	public void checkPhone(String phone){
		if (phone.length() == 0) {
			...
			error.setText(error.getText()+"Please Include the dashes '-'" );
      	}
	}
	...
	public void checkLuckyNum(String luckyNum){
      	...
      	else if (!luckyNum.matches("^([0-9]|[1-9][0-9]|100)$")) {
