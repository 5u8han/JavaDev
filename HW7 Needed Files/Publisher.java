...
public boolean equals( )
   {
	if(getPublisherCity().equals(publisherCity)& publisherName.equals(getPublisherName())) {
   ...
   public static void main( String[] args )
   {
      ...
      System.out.println(p1);//Publisher@6073f712
      System.out.println(p2);//Publisher@43556938
      System.out.println(p3);//Publisher@3d04a311
      System.out.println(p4);//Publisher@7a46a697
//why is my compiler pulling memory references?
   }
}